import{b as x,r as _,d as A,e as J,s as E,c as S,j as h,k as he,a as Ce}from"./index.7e56801c.js";import{q as te}from"./index.45a2c6a0.js";import{a as ge,r as be}from"./tokenAtom.bed01f95.js";import{a as re}from"./axios.77c802c4.js";import{a as ye,f as ve}from"./resizeFile.7379b781.js";import{g as oe}from"./customAxios.4e711c83.js";const we=()=>{const[,r]=x(ge),[,u]=x(be);_.exports.useEffect(()=>{const o=te.parse(window.location.search),d=o==null?void 0:o.token,s=o==null?void 0:o.refreshToken;d&&r(String(d)),s&&u(String(s))},[])},F=A("name",""),M=A("nickname",""),H=A("nicknamecheck",""),I=A("address",""),T=A("addressdetail",""),z=A("phone",""),V=A("phoneCheck",""),X=A("imgurl","/src/asset/userDefaultImage.png"),Y=A("imgfile",""),ne=A("cardNumber",""),xe=J(null,(r,u,o)=>{u(F,""),u(M,""),u(H,""),u(I,""),u(T,""),u(z,""),u(V,""),u(X,"/src/asset/userDefaultImage.png"),u(Y,"")}),Pe=J(null,(r,u,o)=>{u(F,o.name),u(X,o.profileImageUrl),o.address&&u(I,o.address),o.addressDetail&&u(T,o.addressDetail),o.nickName&&u(M,o.nickName),o.phoneNumber&&u(z,o.phoneNumber),o.cardNumber&&u(ne,o.cardNumber)}),Oe=J(r=>{const u=r(F),o=r(M),d=r(I),s=r(T),m=r(z),C=r(ne);return{name:u,nickName:o,phoneNumber:m,profileImageUrl:"",address:d,addressDetail:s,cardNumber:C}}),ke=E.div`
  display: flex;
